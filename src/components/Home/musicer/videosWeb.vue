<template>
        <transition name="slide-fade">
            <div v-show="show" class="videosWeb">
                <!-- <div v-if="showBigContext" id="videosShowBigContext" class="showBigContext">
                    <div id="videosBackDiv" @click="backTurn" class="backDiv">
                        <img src="../../../assets/icons/back.png" />
                        <span>back</span>
                    </div>
                </div> -->
                <div v-if="showNomalContext" id="videosShowNomalContext" class="showNomalContext">
                    <div v-show="inside" class="videosWebtitle" style="z-index: 9;">
                            <span>videos</span>
                            <div class="contexts">coming soon</div>
                    </div>
                </div>
                <div v-show="show" id="videosclap" class="videosclap"></div>
            </div>
        </transition>
</template>
...
.videosWeb {
    position:absolute; width:190px; height:240px; top:425px; right:300px; z-index:10; border-radius:8px;
    .showNomalContext {
    ...
    .showBigContext {
        ...
        .videosContext::-webkit-scrollbar{
                display:none;
        }
    }
    .videosWebtitle {
